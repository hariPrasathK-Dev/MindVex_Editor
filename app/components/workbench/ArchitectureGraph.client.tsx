...
import type { ElementsDefinition, EdgeDefinition, NodeDefinition, EventObject, NodeSingular, EdgeSingular } from 'cytoscape';
...
export function ArchitectureGraph() {
        ...
        style: [
          {
            ...
            style: {
              ...
              'background-color': (ele: NodeSingular) => {
                ...
                switch(type) {
                  case 'module': return '#3B82F6'; // blue
          ...
          },
          {
            ...
            style: {
              ...
              'line-color': (ele: EdgeSingular) => {
                const type = ele.data('type');
                switch(type) {
                  case 'import': return '#3B82F6'; // blue
                  case 'call': return '#EC4899';   // pink
                  case 'inheritance': return '#10B981'; // green
                  case 'dependency': return '#F59E0B'; // yellow
                  case 'usage': return '#8B5CF6'; // purple
                  default: return '#6B7280'; // gray
                }
              },
              'target-arrow-color': (ele: EdgeSingular) => {
                ...
                switch(type) {
                  ...
                  case 'call': return '#EC4899';
                  case 'inheritance': return '#10B981';
  ...
  const updateGraph = async (changedFiles: Array<{ path: string; content: string }>) => {
    if (!graph || !changedFiles.length) return;
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">
              Visualize your codebase architecture and dependencies
            </p>
          </div>
        ...
        {graph ? (
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-gray-700">
              ...
              <div 
                ref={containerRef} 
                className="w-full h-[600px] bg-gray-900/50 rounded-lg border border-gray-700"
              />
            </div>
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-400 max-w-md">
              Analyzing your codebase to construct an architecture and dependency graph of modules, classes, functions, and their relationships.
            </p>
          </div>
        )}
      </div>
