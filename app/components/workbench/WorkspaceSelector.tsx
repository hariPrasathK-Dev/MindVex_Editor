...
import { workspacesStore, currentWorkspaceStore, createWorkspace, setCurrentWorkspace, workspacesLoadingStore } from '~/lib/stores/workspaceStore';
...
export function WorkspaceSelector() {
    ...
    return (
        <div className="flex flex-col gap-2 p-3 bg-mindvex-elements-background-depth-1 rounded-lg border border-mindvex-elements-borderColor">
            ...
            {showCreateForm && (
                <form onSubmit={handleCreateWorkspace} className="flex flex-col gap-2 p-2 bg-mindvex-elements-background-depth-2 rounded border border-mindvex-elements-borderColor">
                    <input
                        type="text"
                ...
                <div className="flex flex-col gap-1 max-h-48 overflow-y-auto">
                    ...
                    {workspaces.map((workspace) => (
                        <button
                            ...
                            className={`px-2 py-1.5 text-sm text-left rounded transition-colors ${currentWorkspace?.id === workspace.id
